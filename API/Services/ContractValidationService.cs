            ...
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                using (var scope = _scopeFactory.CreateScope())
                {
                    ...
                    foreach (var automobile in expiredAutomobiles)
                    {
                        ...
                        expiredContracts.Add(automobile);
                    ...
                    // Generate reports of validated and expired contracts
                    await GenerateValidatedContractsReportAsync(context);
                    await GenerateExpiredContractsReportAsync(expiredContracts);
                }
